...
export default function App() {
  ...
  <div className="flex flex-col space-y-4">
    <Button
      ...
      className="w-full flex flex-col items-center justify-center space-y-1 md:flex-row md:justify-start md:space-x-2"
    >
        ...
        <div className="w-3/4">
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Textarea id="description" value={taskDescription} onChange={(e) => setTaskDescription(e.target.value)} className="w-full" />
                  </div>
                  <div className="space-y-2">
                    <Label htmlFor="deadline" className="text-sm font-medium">Deadline</Label>
                    <Input id="deadline" type="datetime-local" value={taskDeadline} onChange={(e) => setTaskDeadline(e.target.value)} className="w-full" />
                  </div>
                  <div className="space-y-2">
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  ...
                  {notificationType === 'email' && (
                    <div className="space-y-2">
                      <Label htmlFor="email" className="text-sm font-medium">Email</Label>
                      <Input id="email" value={notificationEmail} onChange={(e) => setNotificationEmail(e.target.value)} className="w-full" />
                    </div>
                  )}
                  {notificationType === 'whatsapp' && (
                    <div className="space-y-2">
                      <Label htmlFor="whatsapp" className="text-sm font-medium">WhatsApp Number</Label>
                      <Input id="whatsapp" value={notificationWhatsApp} onChange={(e) => setNotificationWhatsApp(e.target.value)} className="w-full" />
                    </div>
                  )}
                </CardContent>
                <CardFooter>
          ...
          {view === 'notify-details' && (
            ...
            >
              <Card>
                <CardHeader>
                  <CardTitle className="text-2xl font-bold">Notify Details</CardTitle>
                </CardHeader>
                <CardContent className="space-y-4">
                  <div className="space-y-2">
                    <Label htmlFor="notification-time" className="text-sm font-medium">Notify Before (minutes)</Label>
                    <Input id="notification-time" type="number" value={notificationTime} onChange={(e) => setNotificationTime(Number(e.target.value))} className="w-full" />
                  </div>
                </CardContent>
                <CardFooter>
                  <Button onClick={saveNotification} className="w-full">
